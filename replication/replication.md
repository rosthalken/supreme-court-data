# Measuring Jurisprudence — Replication Materials

This file links to all data, the fine-tuned model, and replication code for the paper ***Measuring Jurisprudence***. 
...
A fine-tuned model for legal reasoning used in the paper is available on Hugging Face:

* **Legal Reasoning Model:**
[https://huggingface.co/rosamondthalken/legal-reasoning](https://huggingface.co/rosamondthalken/legal-reasoning)

---

## Replication Code

* **Supreme Court Opinion + Metadata Collection**:
  [https://github.com/rosthalken/supreme-court-data](https://github.com/rosthalken/supreme-court-data)

* **Model Evaluation Code**:
  [https://github.com/rosthalken/legal-reasoning](https://github.com/rosthalken/legal-reasoning)

* **Full Replication Notebook**: 
  [https://github.com/rosthalken/supreme-court-data/blob/main/replication/replication.ipynb](https://github.com/rosthalken/supreme-court-data/blob/main/replication/replication.ipynb)
